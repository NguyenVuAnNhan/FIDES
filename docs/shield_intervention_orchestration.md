...
| Stage 1 tripped, Stage 2 missing | `require_camera_voice_check` | Ask the user to open the camera and speak into the app with consent, then call `POST /api/shield/challenge` with mock eKYC image and STT audio refs. |
