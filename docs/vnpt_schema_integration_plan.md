...
| SmartVision | Hackathon Face Camera doc + Postman | Shield visual distress on challenge selfie | `addFile` + `url-file` + `detect-face` | Real adapter maps face scores/landmarks to Shield fields |
